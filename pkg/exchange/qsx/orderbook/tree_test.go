...
func TestTreeMinMaxCachedOnDelete(t *testing.T) {
	st := NewTree()
	for i := 0; i < 100; i += 1 {
...
func TestTreeCeiling(t *testing.T) {
	st := NewTree()
	for i := 0; i < 10; i += 1 {
		k := float64(20 - 2*i)
		st.Put(k, nil)
...
func TestTreePutLinkedListOrder(t *testing.T) {
	st := NewTree()
	for i := 0; i < 100; i += 1 {
		k := rand.Float64()
		st.Put(k, nil)
...
func TestTreePutDeleteLinkedListOrder(t *testing.T) {
	st := NewTree()
	n := 1000
	for i := 0; i < n; i += 1 {
		k := rand.Float64()
...
func benchmarkTreeLimitedRandomInsertWithCaching(n int, b *testing.B) {
	st := NewTree()
...
func BenchmarkTree5kLevelsRandomInsertWithCaching(b *testing.B) {
	benchmarkTreeLimitedRandomInsertWithCaching(5000, b)
}

func BenchmarkTree10kLevelsRandomInsertWithCaching(b *testing.B) {
	benchmarkTreeLimitedRandomInsertWithCaching(10000, b)
}

func BenchmarkTree20kLevelsRandomInsertWithCaching(b *testing.B) {
	benchmarkTreeLimitedRandomInsertWithCaching(20000, b)
}
